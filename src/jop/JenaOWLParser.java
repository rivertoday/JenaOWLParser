...
public class JenaOWLParser {
	...
	public static void main( String[] args) {
		...
		try {
			testFileIn = FileManager.get().open( "F:/Dev/workspace/JenaOWLParser/owlfiles/chinesemedicine.owl");
		} catch(IllegalArgumentException ex) {
			System.out.println( "File not found");
			System.exit( 0);
		}
		// Testing OWL file online
		String testUrlIn = "http://www.semanticweb.org/jianghe/ontologies/2019/1/med_002";
